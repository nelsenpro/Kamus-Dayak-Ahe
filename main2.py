...
def muat_kamus(url='https://raw.githubusercontent.com/nelsenpro/kd/7e6362b0a2a1169c8330de5ff35aa4e3aa1146c0/data-max.json'):
    try:
        ...
        print(f"{Warna.MERAH}Gagal memuat kamus: {e}{Warna.NORMAL}")
        exit(1)
